...
public class MatchController {
    ...
    public Result<CustomerUserVo> matchAndCreateRoom(@Schema(description = "用户ID可不传，后端调试用") @RequestParam(value = "customerId",  required = false) Long customerId,
        ...
        CustomerUserVo match = matchService.matchUser(customerId,initKm,maxKm,stepKm);
